...
public class OAuthV1Client {
    ...
    public  static OAuthV1 accessToken(OAuthV1 oAuth) throws Exception {
        ...
        LogUtil.i(TAG,"Getting Access Token ...... \n RequestToken = " + oAuth.getOauthToken() + "\nOauthVerifier = "
        ...
        LogUtil.i(TAG,"accessToken queryString = " + queryString);
        LogUtil.i(TAG,"accessToken url = " + url);

        String responseData = Q_HTTP_CLIENT.httpGet(url, queryString);

        LogUtil.i(TAG,"accessToken responseData = " + responseData);
