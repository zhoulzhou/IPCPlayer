...
//        httpClient=new DefaultHttpClient(connectionManager, httpParams);
    ...
    public String httpGet(String url, String queryString) throws Exception {
        ...
        LogUtil.i(TAG, "QHttpClient httpGet [1] url = "+url);
        ...
        try {
            ...
            LogUtil.i(TAG, "QHttpClient httpGet [2] StatusLine : "+ response.getStatusLine());
            responseData =EntityUtils.toString(response.getEntity());
            LogUtil.i(TAG, "QHttpClient httpGet [3] Response = "+ responseData);
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            httpGet.abort();
    ...
    public String httpPost(String url, String queryString) throws Exception {
        ...
        URI uri = URIUtils.createURI(tmpUri.getScheme(), tmpUri.getHost(), tmpUri.getPort(), tmpUri.getPath(), 
                queryString, null);
        LogUtil.i(TAG, "QHttpClient httpPost [1] url = "+uri.toURL());
        ...
        try {
            ...
            LogUtil.i(TAG, "QHttpClient httpPost [2] StatusLine = "+response.getStatusLine());
            responseData =EntityUtils.toString(response.getEntity());
            LogUtil.i(TAG, "QHttpClient httpPost [3] responseData = "+responseData);
        } catch (Exception e) {
            e.printStackTrace();
        }finally{
            httpPost.abort();
